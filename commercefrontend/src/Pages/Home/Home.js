...
import AllPlans from '../../Images/Home/subscription-plans-with-account-features-list-included-options-price_189959-1155__1_-removebg-preview.png'; // adjust the path according to your project structure
        ...
        <div className="app-container">
            ...
            <div className="second-card">
                ...
                <div style={{backgroundColor: '#DCF4F4'}}className="secondCard-image-container">
                    <img style={{borderRadius:'10px', height: '100%', width: '65%', marginLeft:'0px'}} src={RedirectToWppImage} className="secondCard-contained-image" />
            ...
            <footer>
                ...
                <div style={{display:'flex'}}>
                    ...
                    <div style={{fontSize:'60%', marginLeft:'10px', marginRight:'10px'}}>MyApp 2023. All rights reserved</div>
                </div>
